...
import 'package:testeeeer/create_post.dart';
import 'package:testeeeer/home.dart';
import 'package:testeeeer/profile.dart'; // Ensure this is the correct path to EventFormScreen
...
Future<void> Singup(
  ...
  var response = await http.post(
    Uri.parse('http://192.168.43.126:8000/api/login'),
    body: <String, String>{
      'email': email,
      'password': password,
    },
