...
class _GetServiceScreenState extends State<GetServiceScreen> {
  ...
  Future<void> fetchServices() async {
    ...
    if (token != null) {
      final response = await http.get(
        Uri.parse('http://192.168.210.21:8000/api/services'),
  ...
  Future<void> fetchCategories() async {
    final response =
        await http.get(Uri.parse('http://192.168.210.21:8000/api/categories'));
  ...
  Future<void> _order(
    ...
    var response = await http.post(
      Uri.parse('http://192.168.210.21:8000/api/orders'),
      headers: {'Authorization': 'Bearer $token'},
      body: {
